...
class StreamTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Slick\Http\Stream', $this->stream);
    }
    
    public function testCanInstantiateWithStreamResource()
    {
        $resource = fopen('php://memory', 'wb+');
        $stream   = new Stream($resource);
        $this->assertInstanceOf('Slick\Http\Stream', $stream);
    }
    ...
    {
        $this->setExpectedException('Slick\Http\Exception\InvalidArgumentException');
    ...
    {
        $this->setExpectedException('Slick\Http\Exception\InvalidArgumentException', 'Invalid stream');
    ...
    public function testRaisesExceptionOnConstructionForNonStreamResources()
    {
        ...
        $this->setExpectedException('Slick\Http\Exception\InvalidArgumentException', 'stream');
        new Stream($resource);
    }
